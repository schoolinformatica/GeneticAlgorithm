...
namespace GeneticAlgorithm
{
    public class GeneticAlgorithm<Ind>
    {
            ...
            Func<Tuple<Ind,Ind>,Tuple<Ind,Ind>> crossover, Func<Ind, double, Ind> mutation)
        {
            ...
            // foreach(var i in initialPopulation) {
            ...
            for (int generation = 0; generation < numIterations; generation++)
            {
                ...
                if(elitism)
                {
                    ...
                    // Console.WriteLine("Best individual: " + bestIndividual.Item1.ToString() + " Fitness: " + computeFitness(bestIndividual.Item1));
                ...
                for (int newInd = startIndex; newInd < populationSize; newInd++)
                {
                    ...
                    // Console.WriteLine(parents.Item1.ToString() +" "+ parents.Item2.ToString());
                ...
                // foreach(var pop in currentPopulation) {
